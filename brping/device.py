...
class PingDevice(object):
    ...
    def __init__(self, payload_dict=None):
        ...
        if payload_dict is not None:
            ...
            my_payload_dict.update(payload_dict)
        else:
            my_payload_dict = definitions.payload_dict_all

        ## A helper class to take care of decoding the input stream
        self.parser = pingmessage.PingParser(payload_dict=my_payload_dict)
    ...
    def handle_message(self, msg):
        ...
        self._src_device_id = msg.src_device_id
